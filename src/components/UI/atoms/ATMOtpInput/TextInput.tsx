      ...
      <div className="block w-full max-w-full">
        {isTextArea ? (
          <textarea
            ...
            autoFocus={autoFocus}
            className={"text-base block w-full rounded-md border-gray-300 focus:border-docsigna-purple placeholder-gray-400 " + extraInputClass}
          ...
          <input
            ...
            className={"text-base block w-full rounded-md border-gray-300 focus:border-docsigna-purple " + extraInputClass}
            placeholder={placeholder}
            onChange={onChangeFunc}
            value={value}
            maxLength={maxLenght}
