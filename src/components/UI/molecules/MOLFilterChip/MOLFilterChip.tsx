...
const MOLFilterChip = <T extends { value: string }>({
  ...
  return (
    <>
      <div
        className={`flex gap-2 shadow pl-2 border border-dashed rounded-md border-gray-300 w-fit bg-white hover:bg-slate-50 items-center cursor-pointer ${selectedItems?.length ? "pr-1.5" : "pr-3"
          }  ${getHeight("small")}`}
