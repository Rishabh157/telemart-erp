      ...
      <div className="overflow-auto md:col-auto col-span-full">
        {filters?.length ? (
          <div className="flex items-center gap-2 overflow-x-auto hide-scroll">
            ...
            {Array.from(searchParams?.entries()).length > 0 && <div
              onClick={() => {
