...
const VerticalNavBar = ({
    ...
    return (
        <div className="h-full  overflow-auto bg-white ">
            {/* Logo & Menu Icon */}
            <div className={`flex px-3 py-2 items-center bg-white sticky top-0 ${isCollapsed ? 'justify-between' : 'justify-between'}`}>
                {/* Logo */}
                {!isCollapsed && (
                ...
                >
                    <div className={`h-[1.5px] w-5 bg-slate-500 transition-all duration-500 ${!isCollapsed && 'origin-top-left translate-x-[1.5px] rotate-45 -mt-3'}`}></div>
                    ...
                    ?.filter((permissionRoute: NavItemType) => {
                        ...
                        return (
                            <div
                                ...
                                className={`flex gap-3 items-center rounded px-1 py-2 cursor-pointer hover:bg-sky-50 transition-all duration-500 text-normal
