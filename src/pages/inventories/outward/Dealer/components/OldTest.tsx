...
//     // checking state from the barcodeList
//     // const [barcodeListDocuments, setBarcodeListDocuments] = useState<
//     //     BarcodeListDocumentsType[]
//     // >([])
...
//     // const handleBarcodeDocuments = (row) => {
//     //     // row?.forEach((ele) => {
//     //     //     // setBarcodeListDocuments((pre)=> [...pre , [{_id : ele?_id , quantity:ele?.quantity , groupName : ele?.groupName , barcodes
//     //     //     //     ,barcodes : []   }]]  )
//     //     // })
//     // }
...
//         const barcode=[...barcodeList]
//         getBarCode(barcodeNumber)
//             .then((res: any) => {
//                 if (res?.data?.status) {
//                     if(!barcode?.length)
//                     {
//                         barcode.push(res?.data?.data)
