...
const DispatchedInvoice = () => {
    return (
        <div className="bg-white border-[1px] border-black py-2">
                ...
                <div className="col-span-7">
                    ...
                    <div>
                        ...
                        <p className="text-[13px]">
                            H.O.:701 Atulya IT Park, Khandwa Road, Near Crystal
                            IT Park,Indore,Madhya
                        </p>
                        <p className="text-[13px]">
            ...
            <div className="grid grid-cols-12 py-1 border-b-[1px] border-black">
                <div className="col-span-12 px-2">
                    <h2 className="font-bold text-[12px]">Buyer information</h2>
                </div>
            </div>
            ...
            <div className="grid grid-cols-12 border-b-[1px] border-black">
                <div className="col-span-6 px-2 py-2 border-r-[1px] border-black">
                    ...
                    <h2 className="text-[13px]">
                        OLD HNO-680 NEW 438 SHIV SHAKYI NAGAR DELHI ROAD MEERUT
                        -250002 MOB NO-7053315228,Meerut , <br />
                        Uttar Pradesh-250002{' '}
                    </h2>

                    <div>
                        <span className="font-bold text-[13px]">Phone No.</span>
            ...
            <div className="grid grid-cols-12 py-1 border-b-[1px] border-black">
                <div className="col-span-12 px-2">
                    <h2 className="font-bold text-[12px]">
                        ...
                        <span>
                            RUPEES ONE LAKHS TWENTY-FIVE THOUSAND FOUR HUNDRED
                            FORTY ONLY
                        </span>
                    </h2>
                </div>
            ...
            <div className="grid grid-cols-12 border-b-[1px] border-black">
                ...
                <div className="col-span-6 px-2 py-2">
                    <h2 className="text-[12px]">
                        I/We hereby declare that my/our Registration Certificate
                        under the GST act is in force on the date on which the
                        sale of the goods specified in this bill/cash memo is
                        made by me/us and that the transaction of sale covered
                        by this bill/cash memo has been affected by me/us in the
            ...
            <div className="grid grid-cols-12 py-1 h-28">
                <div className="col-span-8 pl-2 flex justify-between">
                    <div>
                        <span className="text-[13px]">
                            This is System Generated Invoice hence no Signature
                            or Stamp required.
                        </span>
                    </div>
                </div>
