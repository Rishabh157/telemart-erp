...
import { OutwardRequestSampleListResponse } from 'src/models/OutwardRequest.model'
// import { useGetVendorsQuery } from "src/services/VendorServices";
import OutwardRequestListing from './OutwardSampleTabs'
import { HiDotsHorizontal } from 'react-icons/hi'
...
const columns: columnTypes[] = [
    {
        ...
        flex: 'flex-[1_1_0%]',
        renderCell: (row: OutwardRequestSampleListResponse) => (
...
export default OutwardSampleTabsListingWrapper
