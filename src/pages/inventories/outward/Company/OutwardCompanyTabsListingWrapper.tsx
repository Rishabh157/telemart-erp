/// ==============================================
// Filename:OutwardCompanyTabsListingWrapper.tsx
// Type: List Component
...
import { OutwardRequestCompanyListResponse } from 'src/models/OutwardRequest.model'
// import { useGetVendorsQuery } from "src/services/VendorServices";
import OutwardRequestListing from './OutwardCompanyTabs'
import { HiDotsHorizontal } from 'react-icons/hi'
...
const columns: columnTypes[] = [
    {
        ...
        flex: 'flex-[1_1_0%]',
        renderCell: (row: OutwardRequestCompanyListResponse) => (
...
const OutwardCompanyTabsListingWrapper = () => {
...
export default OutwardCompanyTabsListingWrapper
