...
const PscOrdersListingWrapper = () => {
    ...
    const columns: columnTypes[] = [
        ...
        //     flex: 'flex-[1_1_0%]',
        //     name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_INQUIRY_NUMBER,
        //     align: 'start',
        ...
        // },
        {
            ...
            headerName: 'Order No.',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_ORDER_NUMBER,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_ASSIGNED_DEALER,
            align: 'start',
            extraClasses: 'text-xs min-w-[150px]',
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_ASSIGNED_WEARHOUSE,
            align: 'start',
        ...
        },
        {
            ...
            headerName: 'Approval',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_APPROVAL,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: any) => {
                return (
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_MOBILE_NUMBER,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_CUSTOMER_NAME,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            headerName: 'Status',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_STATUS,
            align: 'start',
            extraClasses: 'text-xs min-w-[150px]',
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_FIRST_CALL_APPROVAL,
            align: 'start',
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => {
                return (
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_FIRST_CALL_REMARK,
            align: 'start',
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_FIRST_CALL_STATE,
            align: 'start',
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_FIRST_CALL_BACK_DATE,
            align: 'start',
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_ORDER_REFRENCE_NUMBER,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_TRACKING_NUMBER,
            align: 'start',
            extraClasses: 'text-xs min-w-[150px]',
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_SHIPPING_CHARGES,
            align: 'start',
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_SCHEME_NAME,
            align: 'center',
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            headerName: 'Quantity',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_SHCEME_QUANTITY,
            align: 'center',
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            headerName: 'Price',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_PRICE,
            align: 'center',
            extraClasses: 'text-xs min-w-[150px]',
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_PAYMENT_MODE,
            align: 'center',
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_CREATED_AT,
            extraClasses: 'text-xs min-w-[150px]',
        ...
        },
        {
            ...
            headerName: 'EDP Date',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_EDP_DATE,
            extraClasses: 'text-xs min-w-[150px]',
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_DISPOSITION_LEVELS,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
                <div>
        ...
        },
        {
            ...
            headerName: 'District',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_DISTRICT,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            headerName: 'Taluk',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_TALUK,
            align: 'start',
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            headerName: 'Pincode',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_PIN_CODE,
            align: 'center',
            extraClasses: 'text-xs min-w-[150px]',
        ...
        },
        {
            ...
            headerName: 'Area',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_AREA,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_CHANNEL_NAME,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            headerName: 'CC Name',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_CALL_CENTER,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            headerName: 'Remark',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_REMARK,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            headerName: 'Agent',
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_AGENT,
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => (
        ...
        },
        {
            ...
            flex: 'flex-[3_3_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_PREFFERED_DELIVERY_DATE,
            align: 'start',
            extraClasses: 'text-xs min-w-[150px]',
        ...
        },
        {
            ...
            flex: 'flex-[3_3_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_PREFFERED_DELIVERY_TIME,
            align: 'start',
            extraClasses: 'text-xs min-w-[150px]',
            renderCell: (row: OrderListResponse) => {
        ...
        },
        {
            ...
            flex: 'flex-[1_1_0%]',
            name: UserModuleNameTypes.ORDER_PSC_TAB_LIST_ORDER_MBK_NUMBER,
...
export default PscOrdersListingWrapper
