...
const EditTapeManagementWrapper = () => {
	...
	const initialValues: FormInitialValues = {
		tapeName:
			selectedItem?.tapeName ||
			"",
		channelGroup:
			selectedItem?.channelGroup ||
			"",
		tapeType:
			selectedItem?.tapeType ||
			"",
		scheme:
			selectedItem?.scheme ||
			"",
	...
	const dropdownOptions = {
		...
		channelGroupOptions:
			...
			[],
		schemeDataOption: schemeData?.map(
			(
				schemeItem: SchemeListResponse
			) => {
				return {
					label:
		...
		languageOptions: language?.map(
			(
				languageItem: LanguageListResponse
			) => {
				return {
					label:
