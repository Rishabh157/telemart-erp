...
const StepEditSchemeDetailsWrapper = ({ formikProps,productCategoryoption,productSubCategoryOption,setSelectedCategory}: Props) => {
  ...
  return (
    <>
      <StepEditSchemeDetail formikProps={formikProps} formFields={formFields}
      dropdownOptions={dropdownOptions} setSelectedCategory={setSelectedCategory}
   />
    </>
