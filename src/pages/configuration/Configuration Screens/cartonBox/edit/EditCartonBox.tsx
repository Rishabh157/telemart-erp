                    ...
                    <div className="grow py-8 px-3 ">
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <ATMTextField
                                ...
                                value={(values.innerItemsCount === 0)? "": values.innerItemsCount}
                            ...
                            <div>
                                ...
                                <div className="flex gap-2 mt-2">
                                    ...
                                    <ATMTextField
                                        ...
                                        value={(values.dimensions.height === 0)? "" : values.dimensions.height}
                                        onChange={(e) => {
                                            const inputValue = e.target.value
                                            if (!isNaN(Number(inputValue))) {
                                                setFieldValue(
                                    ...
                                    <ATMTextField
                                        ...
                                        value={(values.dimensions.width === 0)? "" : values.dimensions.width}
                                        onChange={(e) => {
                                            const inputValue = e.target.value
                                            if (!isNaN(Number(inputValue))) {
                                                setFieldValue(
                                    ...
                                    <ATMTextField
                                        ...
                                        value={(values.dimensions.depth === 0)? "" : values.dimensions.depth}
                                        onChange={(e) => {
                                            const inputValue = e.target.value
                                            if (!isNaN(Number(inputValue))) {
                                                setFieldValue(
                            ...
                            <ATMTextField
                                name="boxWeight"
                                value={(values.boxWeight === 0)? "": values.boxWeight}
