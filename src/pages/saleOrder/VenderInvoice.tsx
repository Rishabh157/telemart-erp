      ...
      <div className='bg-slate-500 py-10'>
        <div className='bg-white  p-6   w-[940px] mx-auto my-auto'>
          <div className='flex justify-end items-center gap-60 pt-2 pr-20'>
            <p className='text-xl font-extrabold text-slate-700'>Debit Note</p>
          ...
          <div className='  flex justify-between px-2 mb-2  items-end'>
            ...
            <div className=''>
              <img className='w-44 h-40' src="https://cdn.pixabay.com/photo/2021/12/12/16/10/qr-6865526_1280.png" alt="" />
            </div>
          </div>
          ...
          <div className='border-2 border-t-0 border-slate-900'>
            <div className=' grid grid-cols-2'>
              ...
              <div className=' border-r-2 border-t-2 border-slate-900  '>
                <div className='p-1' >
                  <p className='font-bold text-lg'>Telemart</p>
                  <p>
                ...
                <div className='border-t-2 border-slate-900 p-1 '>
                  ...
                  <p className='font-bold text-lg'>A K Enterprises</p>
                  <p>
              ...
              <div  >
                <div className='grid grid-cols-2 border-t-2 border-slate-950'>
                  <div className='border-b-2 border-r-2 border-slate-900  px-2  '>Debit Note No.<p className='font-bold '>DN/fy24/895</p></div>
                  <div className='border-b-2 border-slate-900  px-2  '>Dated<p className='font-bold '>30-Sep-23</p></div>
                  <div className='border-b-2 border-r-2 border-slate-900  px-2 h-9 '><p className='font-bold '></p></div>
                  <div className='border-b-2 border-slate-900  px-2  '>Mode/Terms of Payment<p className='font-bold '></p></div>
                  <div className='border-b-2 border-r-2 border-slate-900  px-2  '>Original Invoice No. & Date<p className='font-bold '>DN/FY24/895 dt. 30-Sep-23</p></div>
                  <div className='border-b-2 border-slate-900  px-2  '>Other References</div>
                  <div className='border-b-2 border-r-2 border-slate-900  px-2  '>Buyer’s Order No.</div>
                  <div className='border-b-2  border-slate-900  px-2 h-9 '>Dated</div>
                  <div className='border-b-2 border-r-2 border-slate-900  px-2  '>Dispatch Doc No..<p className='font-bold '>DN/fy24/895</p></div>
                  <div className='border-b-2  border-slate-900  px-2 h-9 '></div>
                  <div className='border-b-2 border-r-2 border-slate-900  px-2 h-9 '>Dispatched through</div>
                  <div className='border-b-2  border-slate-900  px-2  '>Destination</div>
                  <div className=' border-slate-900  px-2  '>Terms of Delivery</div>
                ...
                <table width='100%' className='text-center'>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td></td>
                      <td></td>
                      <td className='font-bold border-t-2 border-slate-850'>4,460.71</td>
                    </tr>
                    ...
                    <tr className='border-t-2 border-b-2 border-slate-900 '>
                      <td></td>
                      <td className='font-bold text-end pr-1'>Total </td>
                      <td></td>
                      <td></td>
                      <td></td>
                      <td></td>
