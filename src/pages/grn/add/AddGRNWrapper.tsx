...
const AddGRNWrapper = (props: Props) => {
    ...
    const validationSchema = object({
        ...
        goodQuantity: number()
            ...
            .max(ref("receivedQuantity"),"Good Quantity must be less than or Equal to Receive Quantity")
            .required('Please enter Good Quantity'),
        defectiveQuantity: number()
            .min(0, 'Defective Quantity must be greater than 0')
            .max(ref("receivedQuantity"),"Defective Quantity must be less than or Equal to Receive Quantity")
