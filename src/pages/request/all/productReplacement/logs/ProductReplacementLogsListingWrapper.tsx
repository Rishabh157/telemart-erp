...
import ProductReplacementLogsListing from './ProductReplacementLogsListing'
import { useGetAllProductReplacementLogsByIdQuery } from 'src/services/ProductReplacementServices'
...
const ProductReplacementLogsListingWrapper = () => {
    ...
    const { data, isLoading, isFetching } =
        useGetAllProductReplacementLogsByIdQuery(id, {
            skip: !id,
        })
...
export default ProductReplacementLogsListingWrapper
