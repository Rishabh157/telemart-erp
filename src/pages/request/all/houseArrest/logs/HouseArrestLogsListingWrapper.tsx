...
import HouseArrestLogsListing from './HouseArrestLogsListing'
import { useGetAllHouseArrestLogsByIdQuery } from 'src/services/HouseArrestServices'
...
const HouseArrestLogsListingWrapper = () => {
    ...
    const { data, isLoading, isFetching } = useGetAllHouseArrestLogsByIdQuery(
        id,
        {
            skip: !id,
        }
...
export default HouseArrestLogsListingWrapper
