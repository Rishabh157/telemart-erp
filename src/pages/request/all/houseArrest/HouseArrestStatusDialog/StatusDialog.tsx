...
const StatusDialog = ({
    ...
    const rows: any[] = [
        ...
        },
        {
            ...
            district: (
                <>
                    {houseArrestData.managerFirstApproval ? (
                        <FaCheckCircle color="green" />
                    ) : (
                        <ImCross color="red" />
                    )}{' '}
            ...
            remark: `${
                houseArrestData.managerFirstRemark
                    ? houseArrestData?.managerFirstRemark
                    : '-'
            }`,
            date: (
        ...
        },
        {
            ...
            district: (
                <>
                    {houseArrestData.dealerApproval ? (
                        <FaCheckCircle color="green" />
                    ) : (
                        <ImCross color="red" />
                    )}{' '}
        ...
        },
        {
            ...
            district: (
                <>
                    {houseArrestData.managerSecondApproval ? (
                        <FaCheckCircle color="green" />
                    ) : (
                        <ImCross color="red" />
                    )}{' '}
            ...
            remark: `${
                houseArrestData.managerSecondRemark
                    ? houseArrestData?.managerSecondRemark
                    : '-'
            }`,
            date: (
        ...
        },
        {
            ...
            district: (
                <>
                    {houseArrestData.accountApproval ? (
                        <FaCheckCircle color="green" />
                    ) : (
                        <ImCross color="red" />
                    )}{' '}
