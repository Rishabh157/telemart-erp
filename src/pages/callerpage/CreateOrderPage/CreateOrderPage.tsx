...
import { useGetSchemeByIdAuthQuery } from 'src/services/SchemeService'
...
import { FormInitialValues } from './CreateOrderPageWrapper'
...
const CreateOrderPage: React.FC<Props> = ({
    formikProps,
    didItems,
    activeTab,
    setActiveTab,
    ...
    } = useGetSchemeByIdAuthQuery(values?.schemeId, {
    ...
    const { options: allDispositionItems } = useCustomOptions({
        useEndPointHook: useGetAllDispositionThreeByDisTwoIdQuery(
