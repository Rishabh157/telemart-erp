...
export interface DisabledFieldsPropsTypes {
    ...
    isTehsil: boolean
    isArea: boolean
    isTypeOfAddress: boolean
    isCustomerName: boolean
    isPrefferedDelDateStartTime: boolean
    isPrefferedDelDateEndTime: boolean
    isPrefferedDelDateTime: boolean
    isHouseFlat: boolean
    isStreetSector: boolean
    isLandmark: boolean
    isWhatsappNumber: boolean
    isAutoFillingShippingAddress: boolean
    isGender: boolean
    isOrderFor: boolean
    isAgeGroup: boolean
    isEmailId: boolean
    isSocialMediaFacebook: boolean
    isSocialMediaInstagram: boolean
    isMedicalIssue: boolean
    isPaymentMode: boolean
    isOtherRemark: boolean
}
...
const CourierNdrDialerPage: React.FC<Props> = ({
    formikProps,
    didItems,
    activeTab,
    setActiveTab,
    ...
    const disabledFields: DisabledFieldsPropsTypes = {
        ...
        isTehsil: true,
        isArea: true,
        isTypeOfAddress: true,
        isCustomerName: true,
        isPrefferedDelDateStartTime: true,
        isPrefferedDelDateEndTime: true,
        isPrefferedDelDateTime: true,
        isHouseFlat: true,
        isStreetSector: true,
        isLandmark: true,
        isWhatsappNumber: true,
        isAutoFillingShippingAddress: true,
        isGender: true,
        isOrderFor: true,
        isAgeGroup: true,
        isEmailId: true,
        isSocialMediaFacebook: true,
        isSocialMediaInstagram: true,
        isMedicalIssue: true,
        isPaymentMode: true,
        isOtherRemark: true,
    }
...
export default CourierNdrDialerPage
