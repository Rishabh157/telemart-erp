...
const tabs: tabsProps[] = [
    {
        ...
        name: UserModuleNameTypes.ACTION_REPORTS_AGENT_HIERARCHY,
    },
    {
    ...
    },
    {
        ...
        name: UserModuleNameTypes.ACTION_REPORTS_AGENT_WISE_COMPLAINT,
    },
    {
    ...
    },
    {
        ...
        icon: MdOutbond,
        path: 'call-back',
        name: UserModuleNameTypes.ACTION_REPORTS_AGENT_DETAILS_CALL_BACK,
    },
    {
        label: 'Day Wise Agent Performance',
        icon: MdOutbond,
        path: 'day-wise-agent-performance',
        name: UserModuleNameTypes.ACTION_REPORTS_DAY_WISE_AGENT_PERFORMANCE,
    },
    // {
