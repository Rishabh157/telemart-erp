...
import { setFilterValue, setSelectedDispostion } from 'src/redux/slices/configuration/dispositionTwoSlice'
...
DispositionOneListing = ({dispositionOne}:Props) => {
  ...
  return (
    ...
    />
    {isOpenAddForm && (
        <AddDispositionOneWrappper onClose={() => setisOpenAddForm(false)} />
    )}
</>
  )
}
