...
import DispositionOneListFilterFormDialog from './DispositionOneListFilterFormDialog'
import { setIsActivateUser } from 'src/redux/slices/configuration/dispositionOneSlice'
...
const DispositionOneListFilterFormDialogWrapper = ({
    open,
    onClose,
}: Props) => {
...
export default DispositionOneListFilterFormDialogWrapper
