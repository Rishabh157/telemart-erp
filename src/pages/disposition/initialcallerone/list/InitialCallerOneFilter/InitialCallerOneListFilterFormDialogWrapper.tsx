...
import InitialCallerOneListFilterFormDialog from './InitialCallerOneListFilterFormDialog'
import { setIsActivateUser } from 'src/redux/slices/configuration/initialCallerOneSlice'
...
const InitialCallerOneListFilterFormDialogWrapper = ({
    open,
    onClose,
}: Props) => {
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="xs" fullWidth>
            ...
            >
                {(formikProps) => (
                    <Form>
                        <InitialCallerOneListFilterFormDialog
                            onClose={onClose}
...
export default InitialCallerOneListFilterFormDialogWrapper
