...
import { FormInitialValues } from './DispositionTwoListFilterFormDialogWrapper'
...
const DispositionTwoListFilterFormDialog = ({
    formikProps,
    onReset,
    onClose,
}: Props) => {
...
export default DispositionTwoListFilterFormDialog
