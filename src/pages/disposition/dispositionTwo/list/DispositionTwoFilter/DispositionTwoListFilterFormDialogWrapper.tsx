...
import DispositionTwoListFilterFormDialog from './DispositionTwoListFilterFormDialog'
import { setIsActivateUser } from 'src/redux/slices/configuration/dispositionTwoSlice'
...
const DispositionTwoListFilterFormDialogWrapper = ({
    open,
    onClose,
}: Props) => {
    ...
    return (
        <Dialog open={open} onClose={onClose} maxWidth="xs" fullWidth>
            ...
            >
                {(formikProps) => (
                    <Form>
                        <DispositionTwoListFilterFormDialog
                            onClose={onClose}
...
export default DispositionTwoListFilterFormDialogWrapper
