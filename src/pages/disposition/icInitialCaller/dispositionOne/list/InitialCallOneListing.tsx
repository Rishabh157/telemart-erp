...
import { setFilterValue, setSelectedInitialCallerTwo } from 'src/redux/slices/configuration/initialCallerTwoSlice'
...
const InitialCallOneListing = ({initialCallerOne}:Props) => {
  ...
  return (
    ...
    />
    {isOpenAddForm && (
        <AddInitialCallOneWrapper onClose={() => setisOpenAddForm(false)} />
    )}
</>
  )
}
