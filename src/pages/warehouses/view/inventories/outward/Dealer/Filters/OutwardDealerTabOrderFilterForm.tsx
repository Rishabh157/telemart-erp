...
import { FormInitialValuesFilterWithLabel } from './OutwardDealerTabFilterFormWrapper'
...
const OutwardDealerTabOrderFilterForm = ({
    formikProps,
    onReset,
    onClose,
}: Props) => {
...
export default OutwardDealerTabOrderFilterForm
