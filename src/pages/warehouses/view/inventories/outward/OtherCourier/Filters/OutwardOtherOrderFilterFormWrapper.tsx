...
import OutwardGpoOrderFilterForm from './OutwardOtherOrderFilterForm'
...
const OutwardOtherOrderFilterFormWrapper = ({
    open,
    onClose,
    filter,
    setFilter,
...
export default OutwardOtherOrderFilterFormWrapper
