...
import { FormInitialValuesFilterWithLabel } from './OutwardOtherOrderFilterFormWrapper'
...
const OutwardOtherOrderFilterForm = ({
    formikProps,
    onReset,
    onClose,
}: Props) => {
        ...
        <div className="flex flex-col gap-4 px-4 py-2">
            ...
            <div className="grid grid-cols-2 gap-x-6">
                ...
                <ATMSelectSearchable
                    ...
                    name="productGroup"
                    value={values.productGroup.value}
...
export default OutwardOtherOrderFilterForm
