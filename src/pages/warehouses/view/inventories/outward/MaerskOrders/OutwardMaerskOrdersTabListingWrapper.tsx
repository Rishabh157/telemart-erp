...
import OutwardMaerskOrdersTabListing from './OutwardMaerskOrdersTabListing'
...
const OutwardMaerskOrdersTabListingWrapper = () => {
    useUnmountCleanup()
    const { id } = useParams()
...
export default OutwardMaerskOrdersTabListingWrapper
