...
import { FormInitialValues } from './EditOrderCancelRequestWrapper'
...
const EditOrderCancelRequest = ({ formikProps, apiStatus }: Props) => {
    ...
    return (
        <div className="h-[calc(100vh-55px)] overflow-auto">
            <div className="flex flex-col gap-2 p-4 ">
                ...
                {/* Page Heading */}
                <div className="pt-1">
                    <ATMPageHeading> Edit Order Cancel Request </ATMPageHeading>
                </div>
...
export default EditOrderCancelRequest
