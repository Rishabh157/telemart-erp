...
import { useGetDealerSchemeByIdQuery, useUpdateDealerSchemeMutation } from 'src/services/DealerSchemeService'
...
import { UpdateDealerSchemeInitialValues, DealerSchemeByIdResponse } from 'src/models/DealerScheme.model'
...
const EditDealerSchemeWrapper = () => {
  ...
  const { data, isLoading, isFetching } = useGetDealerSchemeByIdQuery(schemeId || "")
