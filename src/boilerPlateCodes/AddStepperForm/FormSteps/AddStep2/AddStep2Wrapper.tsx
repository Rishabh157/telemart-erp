...
const AddStep2Wrapper = ({ formikProps }: Props) => {
  ...
  return (
    <>
      <AddStep2 formikProps={formikProps} dropdownOptions= {dropdownOptions} formFields={formFields} />
    </>
  );
};

export default AddStep2Wrapper;
