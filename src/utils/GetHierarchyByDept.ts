...
export const getHierarchyByDept = ({ department }: { department: keyof typeof GetHierarchByDeptProps }) => {
  const defaultComponent = {
    ...
    [GetHierarchByDeptProps.DISTRBUTION_DEPARTMENT]: Hierarchy.distributionDepartment,
    [GetHierarchByDeptProps.FINANACE_DEPARTMENT]: Hierarchy.financeDepartment,
    [GetHierarchByDeptProps.MEDIA_DEPARTMENT]: Hierarchy.mediaDepartment,
    [GetHierarchByDeptProps.MEDIAPRODUCTION_DEPARTMENT]: Hierarchy.mediaProductionDepartment,
    [GetHierarchByDeptProps.IT_DEPARTMENT]: Hierarchy.ITDepartment,
    [GetHierarchByDeptProps.DEVELOPMENT_DEPARTMENT]: Hierarchy.DevelopmentDepartment,
    [GetHierarchByDeptProps.WEB_DEPARTMENT]: Hierarchy.webDepartment,
    [GetHierarchByDeptProps.OPERATION_DEPARTMENT]: Hierarchy.operationDepartment,
    [GetHierarchByDeptProps.QUALITY_DEPARTMENT]: Hierarchy.qualityDepartment,
    [GetHierarchByDeptProps.LOGISTIC_DEPARTMENT]: Hierarchy.logisticDepartment,
    [GetHierarchByDeptProps.MAPPING_DEPARTMENT]: Hierarchy.mapingAndMISDepartment,
