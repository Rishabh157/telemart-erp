      ...
      <div className="py-2">
        <div className='flex justify-between py-6 items-center border-b border-black'>
          ...
          <div className='flex flex-col items-end'>
            <span> Regd. Office:701 Atulya IT Park,  Khandwa Road, Near Crystal IT Park</span>
            <span> </span>
        ...
        <div className='flex justify-between gap-4'>
          <div className='flex flex-col'>
            <span>To</span>
            <span>PANKAJ JI</span>
            <span>ADDPOST + VILL VIRNORA NEAR BY BUS STAND PERNEM,, PINCOD
              403512MOB NO ,9209162825, NEAR BY COLLEGE,,,
              CITY : NORTH GOA STATE : GOA PIN : 403512 </span>
        ...
        <p className='text-center font-extrabold text-[22px]'>Telemart</p>
        <p className="text-center mt-1 font-semibold text-[12px]">701 Atulya IT Park, Khandwa Road, Near Crystal IT Park,Indore - 452001,India</p>
