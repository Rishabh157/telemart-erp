                    ...
                    <div className="border border-black py-2">
                        <div className="flex ">
                            <div className="ml-2">
                                <img
                                    className="h-[80px]"
                                    src="https://media.licdn.com/dms/image/D4D16AQFi9oUf78FdGQ/profile-displaybackgroundimage-shrink_200_800/0/1682586006421?e=2147483647&v=beta&t=ZZDx5BSzWuGLKUl1FtvC50T1QJ-rpqEGSRaNjGkDoG0"
                                    alt=""
                                />
                            </div>
                            <div className="">
                                ...
                                <p className="">GSTIN: 36AATFT1962F1ZS</p>
                            </div>
                        </div>
                        ...
                        <div className="border-b  border-black  py-1 font-extrabold pl-3 ">
                            Buyer information
                        </div>
                        <div className="flex gap-16 pl-2 ">
                            <div className="pb-6">
                                ...
                                <a
                                    ...
                                    className="font-bold"
                                >
                                    EMAIL:sravanthi101293@gmail.com
                                </a>
                            </div>
                        ...
                        <div className="grid py-1 grid-cols-12 px-2 border-y border-slate-900 ">
                            <p className="font-bold col-span-5">
                        ...
                        <div className="grid grid-flow-col grid-cols-12 gap-10 px-2 border-b border-slate-900">
                            ...
                            <p className="col-span-6 border-l border-slate-900 pl-3  mt-1 ">
                                ...
                                this bill/cash memo is made by me/us and that
                                the transaction of sale covered by this
                                bill/cash memo has been affected by me/us in the
                        ...
                        <p className="font-bold text-[14] text-right mt-20">
