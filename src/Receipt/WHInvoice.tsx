      ...
      <div className='bg-slate-500 py-10'>
        <div className="bg-white  p-6 w-[940px] mx-auto my-auto text-[12px]">
          <div className=" border border-black py-2">
            <p className='text-center font-extrabold text-[16px] '>Telemart</p>
            <p className="text-center mt-1 font-semibold ">701 Atulya IT Park, Khandwa Road, Near Crystal IT Park,Indore - 452001,India</p>
            ...
            <div className=" flex justify-between">
              ...
              <div className="mr-[70px] mt-4">
                <img className=' w-[300px] h-[60px]' src="https://static.vecteezy.com/system/resources/thumbnails/008/506/948/small/abstract-digital-code-scanner-barcode-template-for-social-media-payment-market-and-design-png.png" alt="" />
                <p className="font-bold text-center mt-1">TTEL-1-4627</p>
              </div>
            </div>
            ...
            <div className=" flex gap-10 ml-5 mt-1 text-[14px]">
              <div className="">
                <p className="font-semibold text-[11px] ">Ship From Good Warehouse</p>
                <p className="font-bold underline mt-2">Ship From (Warehouse Address) : </p>
                <p className="font-extrabold mt-1">Telemart</p>
                <p className="">
                  Godown Address: 188 Gayatri Nagar, Palda, Near Goyal Flour
                  Mill, Indore -452020,Madhya Pradesh
                </p>
                <p className="">STATE CODE :23</p>
                <p className="">GST NO. : 23AATFT1962F1ZZ</p>
              </div>
              <div className="">
                <p className="font-semibold text-[11px]">Ship To Good Warehouse</p>
                <p className="font-bold underline mt-2">Ship To : </p>
                <p className="font-extrabold mt-1">Telemart</p>
                <p className="">
                  MUNICIPAL NO. 1-11-251/4/B, 5TH FLOOR, TIRUMALA
                  HEIGHTS, Hyderabad, TS, 500016 Hyderabad -500016,Telangana
                </p>
            ...
            <p className="font-semibold  ml-4 mt-2 ">*(Inclusive of all taxes.)</p>
            <p className=" font-bold underline ml-4 mt-3 ">Terms & Conditions :</p>
            ...
            <div className="flex justify-evenly mt-10  ">
              ...
              <p className="mt-5 font-extrabold text-[14px]">Authorized Signatory: </p>
            </div>
          </div>
        </div>
      </div>
