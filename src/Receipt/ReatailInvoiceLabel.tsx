                ...
                <div className="py-2">
                    <div className="flex justify-between py-6 items-center border-b border-black">
                        ...
                        <div className="flex flex-col items-end">
                            <span>
                                {' '}
                                Regd. Office:701 Atulya IT Park, Khandwa Road,
                                Near Crystal IT Park
                            </span>
                            <span> </span>
                    ...
                    <div className="flex justify-between gap-4">
                        <div className="flex flex-col">
                            ...
                            <span>PANKAJ JI</span>
                            <span>
                                ADDPOST + VILL VIRNORA NEAR BY BUS STAND
                                PERNEM,, PINCOD 403512MOB NO ,9209162825, NEAR
                                BY COLLEGE,,, CITY : NORTH GOA STATE : GOA PIN :
                                403512{' '}
                            </span>
                ...
                <div className="py-2">
                    ...
                    <div className=" gap-4 grid grid-cols-12 border-b border-black">
                        ...
                        <div className="col-span-8 flex flex-col">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span>
                                    Mode of Payment.: {items?.paymentMode}
                                </span>
                            </div>
                    ...
                    <div className="border-b border-black">
                        <p className="font-extrabold text-[18px] border-t border-black py-1">
                            AMOUNT IN WORDS : RUPEES TWO THOUSAND FIVE HUNDRED
                            ONLY.
                        </p>
                    ...
                    <div className="flex flex-col justify-center my-2">
                        ...
                        <span className="text-center">
                            ...
                            Certificate under the MP GST Act. is in force on the
                            date on which the sale of the goods specified in
                            this bill/cash memo is made by me/us and that the
                            trasaction of sale covered by this bill/cash memo
                            has been effected by me/us in the regular course of
                            my/our business.
                        </span>
                    </div>
                </div>
