        ...
        <div className="bg-white  p-6 h-[100vh] mx-auto my-auto  text-[12px] font-bold">
          <div className=" border border-black py-2">
            <div className="border-b border-black">
              <p className='text-center font-extrabold text-[14px] '>GURU KRIPA TRADING COMPANY</p>
              <p className="text-center mt-1 px-20 ">
                GYASUDDIN PUR HOUSE 233A/2A, MAHENDRA NAGAR ALLAHBAD, GATI CHAURAH NR SALVI JANEAL STORE,
                PRAYAGRAJ,Allahabad,Uttar Pradesh(9)-211011
              </p>
              <p className=" text-center">GSTIN No.:09APMPJ6149L1Z8,</p>
            ...
            <div className="grid grid-flow-col grid-cols-12 gap-10 px-2 border-b border-slate-900 ">
              <div className=" col-span-5 pt-1 pb-5">
                ...
                <p className="">
                  ...
                  Mill,Indore,Madhya Pradesh(23)-452020
                </p>
              ...
              <p className="col-span-6 border-l border-slate-900 pl-3  mt-1 ">
                <p className="text-center font-extrabold">Sales Return Invoice</p>
                ...
                <div className="flex gap-10 mt-2">
                  ...
                  <p className=" font-normal"> :  11-12-2023</p>
                </div>
                <div className="flex gap-10 mt-2">
            ...
            <div className="pl-2  border-b border-black">
              <div className="flex gap-20 py-2">
                ...
                <p className="font-normal"> RUPEES SIX THOUSAND FOUR HUNDRED FORTY ONLY</p>
              </div>
            </div>
            <div className="flex justify-between  py-2 mb-20 pl-2">
              <p className="font-semibold">This is System Generated Invoice hence no Signature or Stamp required.</p>
              <p className="text-[14px] pr-10">GURU KRIPA TRADING COMPANY</p>
            </div>
          </div>
        </div>
      </div>
