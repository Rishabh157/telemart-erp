            ...
            <div className="py-2">
                ...
                <div className=" gap-4 grid grid-cols-12 border-b border-black">
                    <div className="col-span-4 flex flex-col border-r border-black">
                        <span className='underline'>NAME & ADDRESS OF CUSTOMER:</span>
                        <span>To</span>
                        <span>PANKAJ JI</span>
                        <span>
                    ...
                    <div className="col-span-8 flex flex-col">
                        <div className='flex justify-between'>
                            <span>Order No.: 2066028</span>
                            <span>Order No.: 2066028</span>
                        </div>
                        <div className='flex justify-between'>
                            <span>Invoice No.: RI-Y24-0216617</span>
                            <span>Mode of Payment.: CASH ON DELIVERY</span>
                        </div>
                        <div className='flex justify-center my-2'>
                            <div className="">
                                <span>Maersk Courier</span>
                                <img
                    ...
                    <table width='100%' className=''>
                        ...
                        <tbody className='border-l border-b border-l-black'>
                            <tr>
                                ...
                                <td className={tableCell}>DRINK STOP 1 -DEFAULT
                                    ITEM
                                    CODE:DRINKSTOP-01
                                    SERIAL NO:IN1871671
                                    IMEI NO:NA</td>
                            ...
                            <tr className='border-t py-1'>
                                <td colSpan={2} className={tableCell}>TOTAL</td>
                ...
                <div className='border-b border-black'>
                    ...
                    <div className='mt-1 flex flex-col'>
                        <span>Sold By:-</span>
                        <span>Telemart</span>
                        <span>If undelivered then return to :
                        </span>
                        <span>Telemart</span>
                        <span>Godown Address: 188 Gayatri Nagar, Palda, Near Goyal Flour Mill,,Indore
                        </span>
                        <span>Madhya Pradesh,India-452020
                        </span>
                        <span>GSTIN No:23AATFT1962F1ZZ
                        </span>
                        <span>For Complaint & Telephonic Demonstration +91 7770884999
                        </span>
                ...
                <div className='flex flex-col justify-center my-2'>
                    <span className='underline font-extrabold text-center'>Customer Self Declaration</span>
                    <span className='font-extrabold mt-4 text-center'>To Whomsoever It May Concern</span>

                    <span className='text-center'>
                        I/We hereby certify that my/our Registration Certificate under the MP GST Act. is in force on the date on
                        which the sale of the goods specified in this bill/cash memo is made by me/us and that the trasaction of
                        sale covered by this bill/cash memo has been effected by me/us in the regular course of my/our
                        business.
                    </span>
                </div>
            </div>
