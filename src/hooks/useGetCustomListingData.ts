...
import { setIsTableLoading, setTotalItems } from '../redux/slices/ListingPaginationSlice';
...
const useGetCustomListingData = <T>({ useEndPointHook }: UseCustomPaginationPropsType<T>) => {
