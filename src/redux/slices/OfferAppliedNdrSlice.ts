...
const offerAppliedNdrSlice: Slice<InitialStateType> = createSlice({
    name: 'offerAppliedNdr',
    initialState,
    reducers: {
...
export const {
    ...
    setAllItems,
    setFilterValue,
} = offerAppliedNdrSlice.actions
export default offerAppliedNdrSlice.reducer
