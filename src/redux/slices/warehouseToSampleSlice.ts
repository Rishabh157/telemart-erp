/// ==============================================
// Filename:warehouseToSampleSlice.ts
...
import { SaleOrderListResponse } from 'src/models/ReturnToVendor.model'
...
const warehouseToSampleSlice: any = createSlice({
    name: 'warehouseToSample',
    initialState,
    reducers: {
        setItems: (
            state,
...
export const {
    ...
    setAllItems,
    setSelectedItem,
} = warehouseToSampleSlice.actions
export default warehouseToSampleSlice.reducer
