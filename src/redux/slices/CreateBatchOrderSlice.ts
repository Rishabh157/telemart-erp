...
const createBatchOrderSlice: Slice<InitialStateType> = createSlice({
    name: 'createBatchSlice',
    initialState,
    reducers: {
...
export const {
    ...
    setAllItems,
    setFilterValue,
} = createBatchOrderSlice.actions
export default createBatchOrderSlice.reducer
